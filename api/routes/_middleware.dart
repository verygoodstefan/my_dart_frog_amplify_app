...
Handler middleware(Handler handler) {
  return handler
      .use(requestLogger())
      .use(bearerAuthentication<AuthUser>(
        ...
        applies: (context) async {
          //need to do something like this to open auth but not other routes
          return !context.request.uri.pathSegments.contains('auth');
        },
      ))
      .use(
